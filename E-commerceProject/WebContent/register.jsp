...
<form class="form-contaner" method="post" action="RegisterServlet">
 <h2>REGISTER</h2>
 <div class="form-group">
    <label for="name">Name</label>
    <input type="text" class="form-control" name="uname" placeholder="John Smith">
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="number" class="form-control" name="pnum" placeholder="xxx-xxx-xxxx">
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="password" class="form-control" name="cpwd" placeholder="Password">
  </div>
